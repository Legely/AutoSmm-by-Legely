...
NAME = "AutoSMM by Legely"
VERSION = "0.1"
DESCRIPTION = "Плагин для автоматической накрутки"
CREDITS = "@IamDimaa"
UUID = "18ade86b-3ad6-4fd6-a0f2-406794c088f4"
SETTINGS_PAGE = False
...
Здесь вы найдете важные ссылки для работы с плагином и сервисами SMM.
    ...
    kb_.row(
        InlineKeyboardButton("👨‍💻 Разработчик", url="https://t.me/iamdimaa"),
        InlineKeyboardButton("📣 Канал", url="https://t.me/legelyskins")
    )
    
    kb_.row(
        InlineKeyboardButton("🌐 Smmway", url="https://smmway.ru/ref3801095"),
        InlineKeyboardButton("🌐 Vexboost", url="https://vexboost.ru/ref2943888")
    )
